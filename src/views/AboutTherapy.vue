<template>
  <div>
    <h4>Psychoterapia - dlaczego warto korzystać z psychoterapii?</h4>
    <b-card-group deck class="cards-top-margin">
      <b-card align="left">
        ...
        <ul>
          <li>
            uzależnienia typu; alkohol, narkotyki, hazard, leki, gry
            komputerowe,
          </li>
          <li>
            alkoholizm i inne uzależnienia w rodzinie, współmałżonka czy
            dziecka,
          </li>
        ...
        <p>Proponowane formy terapii to:</p>
        <ul>
          <li>Terapia Indywidualna</li>
          <li>Terapia Grupowa,</li>
          <li>Terapia Rodzinna,</li>
          <li>Terapia Małżeńska.</li>
        </ul>
        <p>Nie uciekaj od problemów, rozwiąż je z pomocą specjalisty!</p>
      </b-card>
      <b-card class="description">
        ...
        <p>
          ...
          pacjent i psychoterapeuta, decydują czy podjąć dalszą
          psychoterapię.
        </p>
      </b-card>
    </b-card-group>
